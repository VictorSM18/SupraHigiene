...
<h1 align="center" > Configurar su cuenta </h1>
...
<label> Nacionalidad del cliente: </label>
...
echo "<script>alert('Su cuenta ha sido actualizada, vuelva a iniciar sesion')</script>";
