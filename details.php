  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">VISTA DE PRODUCTO </span>
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<label class="col-md-5 control-label" >Cantidad del producto </label>
...
<label class="col-md-5 control-label" >Cantidad del paquete </label>
...
<i class="fa fa-heart" ></i> Añadir a Lista de Deseados
...
echo "<script>alert('Tiene que iniciar sesion para agregar el articulo a la lista de deseadost')</script>";
...
echo "<script>alert('Este producto ya ha sido agregado a su lista de deseados')</script>";
...
echo "<script> alert('El producto se ha agregado a su lista de deseados') </script>";
...
echo "Descripcion del producto";

}
else{

echo "Descripcion del paquete";
...
<h3 class="text-center"> Puede ser que te interesen estos productos. seleccionamos 3 productos mas vendidos </h3>
...
<h3 class="text-center">Productos en paquete </h3>
