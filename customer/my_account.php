  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">MI CUENTA</span>
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<strong> Alerta! </strong> Por favor confirma tu correo electronico si has recibido el email de verficacion
...
echo "<script>alert('Su correo ha sido confirmado')</script>";
...
Pulsa aqui para confirmar el correo
...
echo "<script>alert('Un correo de confirmacion ha sido enviado a su correo, revise su bandeja de entrada')</script>";
