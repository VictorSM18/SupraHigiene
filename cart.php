  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">CARRITO DE COMPRAS</span> 
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > Actualmente usted tiene <?php echo $count; ?> articulos en su carrito. </p>
...
<input class="btn btn-primary" type="submit" name="apply_coupon" value="Aplicar cupon de descuento" >
...
Continuar con la compra <i class="fa fa-chevron-right"></i>
...
echo "<script>alert('Su cupon ya ha sido utilizado')</script>";
...
echo "<script> alert('El codigo utilizado no es valido') </script>";
...
<h3 class="text-center"> Productos que te podrian interesar </h3>
